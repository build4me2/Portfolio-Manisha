...
export const projects = [
  ...
  },
  {
    ...
    href: '#',
    description:
      'Placeholder project for an AI-powered study tool that summarizes notes and generates practice questions.',
    meta: 'AI · PRODUCT · UX',
  },
  {
    ...
    href: '#',
    description:
      'Placeholder project for a searchable campus resource guide with filters, categories, and accessibility-first design.',
    meta: 'WEB APP · DATA · DESIGN',
  },
  {
    title: 'Creative Photo Archive',
    href: '#',
    description:
